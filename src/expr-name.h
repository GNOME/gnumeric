...
NamedExpression *expr_name_add        (Workbook *wb, Sheet *sheet,
				       const char *name,
...
NamedExpression *expr_name_lookup     (Workbook *wb, Sheet *sheet, const char *name);
...
Value    *eval_expr_name       (EvalPosition const * const pos, const NamedExpression *exprn,
