...
static LocaleInfo locale_trans_array[] = {
	...
	{N_("(da_DK)"),"da_DK", LG_OTHER },
	{N_("(de_AT)"),"de_AT", LG_WESTERN_EUROPE },
	{N_("(de_BE)"),"de_BE", LG_WESTERN_EUROPE },
	{N_("(de_CH)"),"de_CH", LG_WESTERN_EUROPE },
	...
	{N_("(en_HK)"),"en_HK", LG_OTHER },
	{N_("(en_IE)"),"en_IE", LG_WESTERN_EUROPE },
	{N_("(en_IN)"),"en_IN", LG_OTHER },
	{N_("(en_NZ)"),"en_NZ", LG_OTHER },
	{N_("(en_PH)"),"en_PH", LG_OTHER },
	{N_("(en_SG)"),"en_SG", LG_OTHER },
	{N_("United States (en_US)"),  "en_US",   LG_NORTH_AMERICA},
	{N_("(en_ZA)"),"en_ZA", LG_OTHER },
	...
	{N_("(es_DO)"),"es_DO", LG_OTHER },
	{N_("(es_EC)"),"es_EC", LG_OTHER },
	{N_("(es_ES)"),"es_ES", LG_WESTERN_EUROPE },
	{N_("(es_GT)"),"es_GT", LG_OTHER },
	{N_("(es_HN)"),"es_HN", LG_OTHER },
	{N_("(es_MX)"),"es_MX", LG_OTHER },
	...
	{N_("(nl_BE)"),"nl_BE", LG_WESTERN_EUROPE },
	{N_("(nl_NL)"),"nl_NL", LG_WESTERN_EUROPE },
	{N_("(nn_NO)"),"nn_NO", LG_OTHER },
	{N_("Norway/Bokmal (no_NO)"),  "no_NO",   LG_WESTERN_EUROPE},
	{N_("(oc_FR)"),"oc_FR", LG_OTHER },
	{N_("(pl_PL)"),"pl_PL", LG_OTHER },
	{N_("POSIX"),"POSIX", LG_OTHER },
	{N_("(pt_BR)"),"pt_BR", LG_OTHER },
	{N_("(pt_PT)"),"pt_PT", LG_OTHER },
	{N_("(ro_RO)"),"ro_RO", LG_OTHER },
	{N_("(ru_RU)"),"ru_RU", LG_OTHER },
	...
	{N_("(sv_FI)"),"sv_FI", LG_OTHER },
	{N_("(sv_SE)"),"sv_SE", LG_OTHER },
	{N_("(ta_IN)"),"ta_IN", LG_OTHER },
	{N_("(te_IN)"),"te_IN", LG_OTHER },
	{N_("(tg_TJ)"),"tg_TJ", LG_OTHER },
	{N_("(th_TH)"),"th_TH", LG_OTHER },
	...
	{N_("(zh_CN)"),"zh_CN", LG_OTHER },
	{N_("(zh_HK)"),"zh_HK", LG_OTHER },
	{N_("(zh_SG)"),"zh_SG", LG_OTHER },
	{N_("(zh_TW)"),"zh_TW", LG_OTHER },
	{NULL,                         NULL,      LG_LAST}
};
