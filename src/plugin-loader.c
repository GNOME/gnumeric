...
static void
gnm_plugin_loader_unload_service_file_opener_real (GnmPluginLoader *loader,
                                                        GnmPluginService *service,
                                                        ErrorInfo **ret_error)
{
...
static void
gnm_plugin_loader_unload_service_file_saver_real (GnmPluginLoader *loader,
                                                       GnmPluginService *service,
                                                       ErrorInfo **ret_error)
{
...
static void
gnm_plugin_loader_unload_service_function_group_real (GnmPluginLoader *loader,
                                                           GnmPluginService *service,
                                                           ErrorInfo **ret_error)
{
