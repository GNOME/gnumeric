...
static GtkActionEntry actions[] = {
	...
	{ "MenuEdit",		NULL, N_("_Edit") },
		{ "MenuEditClear",	NULL, N_("_Clear") },
		{ "MenuEditSheet",	NULL, N_("_Sheet") },
	...
	{ "MenuInsert",		NULL, N_("_Insert") },
		...
		{ "MenuInsertSpecial",		NULL, N_("_Special") },
	{ "MenuFormat",		NULL, N_("_Format") },
		{ "MenuFormatColumn",		NULL, N_("_Columns") },
		{ "MenuFormatRow",		NULL, N_("_Rows") },
		{ "MenuFormatSheets",		NULL, N_("_Sheets") },
	{ "MenuTools",		NULL, N_("_Tools") },
		{ "MenuToolsScenario",	NULL,	N_("Scenario") },
		{ "MenuToolStatisticalAnalysis",	NULL,	N_("_Analysis") },
		{ "MenuANOVA",	NULL,	N_("_ANOVA") },
		{ "MenuToolForecast",	NULL,	N_("_Forecast") },
		{ "MenuToolTTest",	NULL,	N_("_TTest") },
	{ "MenuData",		NULL, N_("_Data") },
		{ "MenuFilter",		NULL,	N_("_Filter") },
		{ "MenuOutline",	NULL,	N_("_Outline") },
		{ "MenuExternalData",	NULL,	N_("_External Data") },
