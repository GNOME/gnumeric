...
void workbook_cmd_format_column_width	   (Sheet *sheet, int new_size_pixels);
void workbook_cmd_format_column_auto_fit   (GtkWidget *widget, Workbook *wb);
void sheet_dialog_set_column_width         (GtkWidget *widget, Workbook *wb);
...
void workbook_cmd_format_row_height        (Sheet *sheet, int new_size_pixels);
void workbook_cmd_format_row_auto_fit      (GtkWidget *widget, Workbook *wb);
void sheet_dialog_set_row_height	   (GtkWidget *widget, Workbook *wb);
