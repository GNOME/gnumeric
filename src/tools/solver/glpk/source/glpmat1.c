...
--
-- #include "glpmat.h"
-- gnum_float *u_solve(MAT *U, gnum_float x[]);
--
-- *Description*
--
...
--
-- #include "glpmat.h"
-- gnum_float *ut_solve(MAT *U, gnum_float x[]);
--
-- *Description*
--
...
--
-- #include "glpmat.h"
-- gnum_float *v_solve(PER *P, MAT *V, PER *Q, gnum_float x[], gnum_float work[]);
--
-- *Description*
--
...
gnum_float *v_solve(PER *P, MAT *V, PER *Q, gnum_float x[], gnum_float _work[])
{     ELEM *e;
      int i, j, flag = 1;
      gnum_float uii, *work = _work;
      if (V->m != V->n)
         fault("v_solve: matrix is not square");
      if (!(P->n == V->m && Q->n == V->m))
         fault("v_solve: permutation matrices have invalid order");
      if (_work == NULL) work = ucalloc(1+V->m, sizeof(gnum_float));
...
--
-- #include "glpmat.h"
-- gnum_float *vt_solve(PER *P, MAT *V, PER *Q, gnum_float x[], gnum_float work[]);
--
-- *Description*
--
...
gnum_float *vt_solve(PER *P, MAT *V, PER *Q, gnum_float x[], gnum_float _work[])
{     ELEM *e;
      int i, j, flag = 1;
      gnum_float uii, *work = _work;
      if (V->m != V->n)
