...
/* ------------------------------------------------------------------------- */
typedef void   (__WINAPI reportfunc)(lprec *lp, int level, char const *format, ...);
...
struct _lprec
{
  ...
  REAL      bb_deltaOF;         /* Minimum OF step value; computed at beginning of lp_solve_solve() */
...
#ifdef __BORLANDC__
lprec* __EXPORT_TYPE __WINAPI lp_solve_make_lp(int rows, int columns);
#else
lprec __EXPORT_TYPE * __WINAPI lp_solve_make_lp(int rows, int columns);
#endif
...
void __EXPORT_TYPE __WINAPI lp_solve_delete_lp(lprec *lp);
...
void __EXPORT_TYPE __WINAPI lp_solve_set_maxim(lprec *lp);
void __EXPORT_TYPE __WINAPI lp_solve_set_minim(lprec *lp);
...
MYBOOL __EXPORT_TYPE __WINAPI lp_solve_set_constr_type(lprec *lp, int row, int con_type);
...
MYBOOL __EXPORT_TYPE __WINAPI lp_solve_set_rh(lprec *lp, int row, REAL value);
...
MYBOOL __EXPORT_TYPE __WINAPI lp_solve_set_mat(lprec *lp, int row, int column, REAL value);
...
MYBOOL __EXPORT_TYPE __WINAPI lp_solve_set_upbo(lprec *lp, int column, REAL value);
REAL __EXPORT_TYPE __WINAPI get_upbo(lprec *lp, int column);
MYBOOL __EXPORT_TYPE __WINAPI lp_solve_set_lowbo(lprec *lp, int column, REAL value);
...
MYBOOL __EXPORT_TYPE __WINAPI lp_solve_set_int(lprec *lp, int column, MYBOOL must_be_int);
...
int __EXPORT_TYPE __WINAPI lp_solve_solve(lprec *lp);
/* Solve the problem */
...
void __EXPORT_TYPE __WINAPI lp_solve_print_lp(lprec *lp);
