...
void sheet_object_polygon_fill_color_set    (SheetObject *so, GnmStyleColor *color);
void sheet_object_polygon_outline_color_set (SheetObject *so, GnmStyleColor *color);
...
void sheet_object_test_font_color_set	(SheetObject *so, GnmStyleColor *color);
