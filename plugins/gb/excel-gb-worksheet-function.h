...
#define EXCEL_GB_WORKSHEET_FUNCTION_CLASS(klass)    (GTK_CHECK_CLASS_CAST ((klass), EXCEL_TYPE_GB_WORKSHEET_FUNCTION, ExcelGBWorksheetFunctionClass))
#define EXCEL_IS_GB_WORKSHEET_FUNCTION(obj)         (GTK_CHECK_TYPE ((obj), EXCEL_TYPE_GB_WORKSHEET_FUNCTION))
#define EXCEL_IS_GB_WORKSHEET_FUNCTION_CLASS(klass) (GTK_CHECK_CLASS_TYPE ((klass), EXCEL_TYPE_GB_WORKSHEET_FUNCTION))
